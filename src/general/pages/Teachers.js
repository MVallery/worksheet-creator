...
return(
  <div>
    <div className="header"><h1>Instantly create differentiated assignments for your students!</h1><p>Save hundreds of hours of planning time by using infinite math to create your own custom assignments.</p>
      <div className="signup">
        ...
        <div className="info-card">
          ...
          <p>
            Customize your assignments to meet the needs of every student in your room. You can quickly create many versions of your assignments tailored to your students individual needs.
          </p>
        </div>
       ...
       <div className="info-card">
          ...
          <p>
            Easily create assignments that spiral back to older concepts so that students do not forget. With Infinite Math you can mix and match any concepts to create a truly unique assignment.
          </p>
        </div>
        <div className="info-card">
          <h3>Infinite</h3>
          ...
          <p>
            Since our program randomly generates the problems you can create an endless amount of activities for your students. <br/>
            <ul>
              <li>Homework</li>
              <li>Warm-ups</li>
              <li>Assessments</li>
